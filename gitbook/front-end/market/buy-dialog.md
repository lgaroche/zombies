...
Create a dialog in `./components/BuyDialog.tsx` similar to the sell or transfer dialogs.&#x20;

It contains a single input form with the quantity of tokens to buy. The user can cancel or proceed with the purchase.&#x20;
